...
<section class="fields-section">
  <div class="field-content">
    <h2><span class="highlight">DỊCH VỤ</span> NỔI BẬT </h2>
    <p>
      Với sứ mệnh mang đến dịch vụ sửa chữa ô tô chất lượng cao và trải nghiệm đẳng cấp cho khách hàng, Gara Phúc Hoàn – uy tín lâu đời – luôn không ngừng cải tiến để đáp ứng các tiêu chuẩn khắt khe nhất trong ngành.</p>
  </div>
    ...
    <div class="footer-section">
      <div class="footer-container">
        ...
        <div class="footer-column">
          <img data-icon="Logo" alt="Garage Logo" class="footer-logo">
